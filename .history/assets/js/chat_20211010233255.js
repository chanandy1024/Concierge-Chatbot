  ...
  if (user_id) {
    ...
    sdk.chatbotGet({
      ...
      $(window).load(function() {
        ...
        //business_id: "DpZ7Xaub8Lhpg7VJdHaPpg"
categories: [{…}]
location: {display_address: Array(2)}
name: "Zenkichi New York"
phone: "+17183888985"
price: "$$$"
rating: 4
review_count: 977
        searchResults.forEach((row, idx) => {
          insertResponseMessage(`${idx+1}. ${row.name}, located at ${row.location.display_address.join(', ')}.`);
        })
      });
    }).catch(err => {
        console.log(err);

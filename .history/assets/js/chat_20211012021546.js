...
$(document).ready(function() {
  ...
  if (user_id) {
    ...
    sdk.chatbotGet({
      ...
      insertResponseMessage(`Welcome back! We found your recent dining suggestions: \n ${data.data.Cuisine} restaurants for a party of ${data.data.Attendees}, on ${data.data.Date}`);
  ...
  function insertResponseMessage(content) {
    $('<div class="message loading new"><figure class="avatar"><img src="https://img.utdstc.com/icon/e24/900/e24900acd4168663557f9857ef904420595fbefc24f47d6141e677d3d6a1f4ee:200" /></figure><span></span></div>').appendTo($('.mCSB_container'));
    updateScrollbar();

    setTimeout(function() {
      $('.message.loading').remove();
      $('<div class="message new"><figure class="avatar"><img src="https://img.utdstc.com/icon/e24/900/e24900acd4168663557f9857ef904420595fbefc24f47d6141e677d3d6a1f4ee:200" /></figure>' + content + '</div>').appendTo($('.mCSB_container')).addClass('new');
      setDate();
      updateScrollbar();
      i++;
    }, 500);

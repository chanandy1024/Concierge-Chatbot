...
def dump_table(data):
    ...
    host = 'search-yelp-restaurants-es-fvux5m65jstc4uowq222ula33m.us-west-2.es.amazonaws.com' 
    region = 'us-west-2' 
    service = 'es'
    credentials = boto3.session.Session(profile_name='ccbd', region_name='us-west-2')

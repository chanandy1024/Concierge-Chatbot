...
def get_suggestions(messages):
    ...
    for message in messages:
        ...
        message['search_results'] = search_es(query=message['Cuisine'].lower())
...
def lambda_handler(event, context):
    try:
        ...
        for each_message in all_messages:
            #print(each_message)
            publish_message(phone_number=each_message['PhoneNumber'], message=each_message)
